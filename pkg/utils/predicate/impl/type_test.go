...
func TestIsA(t *testing.T) {
	...
	verifyPredicate(t, pr(impl.IsA(bdd.TypeOf[io.Reader]())), expectation{value: nil, pass: false})
	verifyPredicate(t, pr(impl.IsA(bdd.TypeOf[io.Writer]())), expectation{value: nil, pass: false})
}
